...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if (!$setup.loading) {
    _push(`<div class="singleUsersPage"><h5>ID: ${ssrInterpolate($setup.userArr.id)}</h5><h6>Name: ${ssrInterpolate($setup.userArr.full_name)}</h6><h6>Username: ${ssrInterpolate($setup.userArr.login)}</h6></div>`);
  } else {
...
//# sourceMappingURL=_id_.48bef1b9.mjs.map
